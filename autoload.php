...
if ( ! class_exists( 'Asset_Manager' ) ) {
	require_once __DIR__ . '/php/traits/trait-conditions.php';
	require_once __DIR__ . '/php/traits/trait-asset-error.php';
	...
	require_once __DIR__ . '/php/class-asset-manager-svg-sprite.php';
}
